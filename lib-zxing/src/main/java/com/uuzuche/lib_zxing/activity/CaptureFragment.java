...
import com.uuzuche.lib_zxing.util.ImageUtil;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public static final int REQUEST_TO_CAPTRUE_SELECT = 1200;
    ...
    private TextView captureSelectTv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        captureSelectTv = (TextView) view.findViewById(R.id.captureSelectTv);
    ...
    private void initEventListener() {
        ...
        captureSelectTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Intent.ACTION_PICK, android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
                startActivityForResult(i, REQUEST_TO_CAPTRUE_SELECT);
            }
        });
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TO_CAPTRUE_SELECT && resultCode == getActivity().RESULT_OK && null != data) {
            ...
            try {
                CodeUtils.analyzeBitmap(ImageUtil.getImageAbsolutePath(getActivity(), imageUri), new CodeUtils.AnalyzeCallback() {
                    @Override
